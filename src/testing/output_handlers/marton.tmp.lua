...
return function(options)
  ...
  ---@return string
  local getTestFilenameFromElement = function(element)
    return element.trace.short_src
  end

  local incrementTestFileCount = function()
  ...
  local incrementTestResultCount = function(testFilename, countFieldName)
    local currentValue =
  ...
  ---@param testFilename string
  local incrementTestFilesFailedCount = function(testFilename)
